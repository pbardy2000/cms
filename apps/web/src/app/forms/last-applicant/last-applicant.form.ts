...
export class LastApplicantForm extends BaseForm {
  override form = this.fb.group({
    techRecord_applicantDetails_name: this.fb.control(null, [this.validators.maxLength(150, 'Name or company')]),
		...
		techRecord_applicantDetails_postTown: this.fb.control(null, [this.validators.maxLength(60, 'Town or city')]),
		techRecord_applicantDetails_address3: this.fb.control(null, [this.validators.maxLength(60, 'County')]),
		techRecord_applicantDetails_postCode: this.fb.control(null, [this.validators.maxLength(12, 'Postcode')]),
